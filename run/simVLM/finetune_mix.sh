...
do
    accelerate launch \
        ...
        --dataset_name $MY_HOME/datasets/VisionFlan/mix_0.75l_${ratio}percent.json \
        ...
        --save_steps 10000 \
        --save_total_limit 1 \
        --output_dir $MY_HOME/models/llava-llama-3_2-3b-${ratio}percent \
        --bf16 True \
        --tf32 True \
        --gradient_checkpointing True \
        --dataloader_num_workers 8 \
        --run_name llava-llama-3_2-3b-${ratio}percent \
        --do_train \
        --report_to wandb 
done